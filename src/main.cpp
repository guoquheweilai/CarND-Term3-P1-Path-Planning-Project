      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          // j[1] is the data JSON object
			...
			// Either we will reference the starting point as where the car is or not at the previous paths end point
			double ref_x = car_x;
			double ref_y = car_y;
			...
			if ( prev_size < 2) {
				// Use two points that make the path tangen to the car
